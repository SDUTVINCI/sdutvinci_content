---
vinciId: 3520bccf-a4d2-4c99-87be-1ee7cf46b287
title: mid360-localization大致流程
description: 实验室终于搞到一块mid360，怀着激动和忐忑的心情，让我们一起学习怎么使用吧！
authors:
  - liuyehan
contributors:
  - dongjiahui
...
![2025\-01\-19 11\-19\-23 的屏幕截图\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2023/12/30/001-0c4ae8192f18.webp)
...
![2025\-01\-19 11\-47\-55 的屏幕截图\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2023/12/30/002-93f277471540.webp)
...
[定位\.mp4](https://cdn.sdutvinci.cn/site-assets/images/wiki/2023/12/30/%E5%AE%9A%E4%BD%8D.mp4)
...
![Screenshot\_20250421\_212345\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2023/12/30/003-4ba5a72e4f80.webp)
...
难点在于局部规划器调参和里程计到机器人坐标系的变换。局部规划、坐标变换、`cmd_vel`生成和上位机运动控制策略由软件算法组负责；嵌入式组负责接收期望速度或位置并完成电机实时闭环、指令超时和失联保护。若在上位机实现PID等控制策略，应明确其控制对象、运行周期和与底层速度环的接口，避免两端重复闭环。
