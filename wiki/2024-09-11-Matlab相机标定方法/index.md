...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/a2296761a8698207.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/002-7a1204e71fe1.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/003-a2b16dc265b5.webp)

5. 点击 Add Images，导入拍照图片。

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/004-70b8a2fe2ed2.webp)

6. 修改棋盘格大小为25mm（你的标定板一个格子大小是多少，就写多少）

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/005-b3c877777377.webp)

7. 对于标准相机，菜单栏的option里选择三阶径向畸变和斜切

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/006-3c188a485ec5.webp)

8. 点击Calibratior，开始标定

- 这个时候，MATLAB会将所有图片进行标定，加载完成后，先看一遍所有图片的标定情况，如果有角点标注不全的情况就右击鼠标，remove删除该图片。

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/007-55972e0a64c8.webp)

9. 拖拉红线，删除误差大的图像对，使投影误差小于0\.1最好。然后导出标定参数。

- 如果误差小于0\.1\~0\.15的图像数量在总体图像中占比较小，请重新拍摄图像，重新进行标注（该组图像拍摄的较差，标定完后数据不会准确）

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/008-4222de98a426.webp)

10. 把相机参数导出来，点击 Export Camera Parameters。点击确定，就可以看到matlab工作区出现了相机参数。点开这个参数，就可以得到相机的各个参数：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/009-20db72c14270.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/010-83de4d8d16d2.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/f1a05f2f93bd05ee.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/012-097c2922f974.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/013-1467b1297443.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/fb7e188ece046321.webp)

该样式本实验室有一个类似产品，可以用于学习双目视觉，但不建议使用到具体工程，精度和使用效果极差。

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/f43a3a56a3f7e520.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/016-b93fb9657638.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/017-cb4a93eaf118.webp)

**右镜头**拍摄到的图：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/018-64e0132eebb6.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/019-31959a444487.webp)

2. 然后将上面的“**Skew**”、“**Tangential Distortion**”以及“**2 Coefficients**”等选项选上，将“3 Coefficients”选项去掉，如下：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/020-7b51d3e18826.webp)

3. 然后点击 **Add images（添加图像）**，出现如下界面：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/021-afa14b8f8d97.webp)

4. **Camera 1 **代表左摄像头，**Camera 2** 代表右摄像头，分别选择存放着左右图像的文件夹，需要特别注意的是棋盘格的边长应该根据打印的实际大小填写** \(例如20mm\)**，单位可以选择

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/022-dc7e0e355b0b.webp)

5. 点击Calibrate按钮，开始标定：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/023-50874a4959b7.webp)

6. 校准

- 从下图可以看到，**平均的标定误差**以及 **标定过程中误差较大**的的图像对。

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/024-0376edb8b74c.webp)

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/025-de9a7a42a8ca.webp)

7. 点击选择不想接受的误差直方图，可以直接在左边的图像对中找到对应的图像，右键选择“**Remove and Recalibrate**”：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/026-ed6018a6d8d6.webp)

可以重复上述步骤，直到认为误差满足标定需求为止。

8. 点击Export camera parameters, 并点击“OK”。

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/027-a67b596ec868.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/028-2a33d2fded5d.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/029-e5ce1f0ea45a.webp)

CameraParameters1与CameraParameters2中包含如下文件：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/030-094c598d067c.webp)

IntrinsicMatrix存放的是摄像头的内参，只与摄像机的内部结构有关，老版本MATLAB需要先**转置**再使用。

例如：左相机的参数，**点击CameraParameters1**

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/031-5bccffe4c5ff.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/032-5a5121f0d892.webp)

这个和OpenCV中是**转置的**关系，注意不要搞错。

对应 ：

![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/033-7eb34e3bee75.webp)
...
![image\.png](https://cdn.sdutvinci.cn/site-assets/images/wiki/2024/09/11/034-bd08bbe354ff.webp)
