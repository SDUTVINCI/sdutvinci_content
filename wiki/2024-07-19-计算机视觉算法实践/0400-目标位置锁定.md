...
![20210814\_70227\.gif](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/001-d2890abeb778.webp)
...
![image\.png](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/002-d3690c36db26.webp)

首先根据摄像头内参矩阵和畸变参数矫正x和y的像素值，之后通过计算可以得到转角，原理在《Learning OpenCV》的第11章「摄像头模型与标定」中有。

像素点与物理世界坐标的关系：其中X、Y、Z为物理世界中点的坐标

![image\.png](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/003-b9555ecf3548.webp)

我们要想得到转角只要得到X/Z和Y/Z，然后通过反三角函数就可以得到需要的角度了。

![image\.png](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/004-d41e55a42e37.webp)
...
![TY1KV9A63%W\]12X8\}67OPZY\_tmb\.jpg](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/005-688079147ba8.webp)

![05VV8K9J\[SI\_63\`I%C\)H\`\)6\.png](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/006-5c0a7ad0b964.webp)

![QLDLZS\]B4P6JY\_2EJT\}\)UTY\.png](http://10.0.0.4:5244/COS/tungwebsite/assets/images/wiki/2024/07/19/007-22212088afd7.webp)
