---
vinciId: 294ab387-72f7-5d4e-958f-e4a921124090
title: 入门操作
description: 简介
authors:
  - dongjiahui
publishedAt: 2023-12-30T00:00:00.000Z
updatedAt: 2026-08-18T16:48:11.638Z
---
...
3. 创建 Dolphin 服务菜单：
   ...
   Name=Open Warp Here
   Icon=dev.warp.Warp
   Exec=/home/你的用户名/.local/bin/warp-here %f
   ```

   `%f` 会由 Dolphin 替换为当前选中的文件夹路径。
   请将 `你的用户名` 替换为当前 Linux 用户名，可通过 `whoami` 查看。
